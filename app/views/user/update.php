...
<div class="max-w-4xl mx-auto bg-white rounded-2xl shadow-2xl p-8 mt-10">
  ...
  <div class="text-center border-b-4 border-pink-500 pb-5 mb-6">
    <h1 class="text-3xl font-extrabold text-pink-600">Update User</h1>
    <p class="text-gray-600 text-lg">Edit the details below and save the changes</p>
  </div>
  ...
  <!-- Update User Form -->
  <form action="<?=site_url('user/update/'.$user['id']);?>" method="post" class="space-y-6 max-w-2xl mx-auto">
    <div>
